...
//! @{
#define	CAN_HW_BUS1		0			//!< CAN BUS 1
#define	CAN_HW_BUS2		1			//!< CAN BUS 2
/*! @}*/
...
typedef struct {
	...
	union {
		...
		u64_t			Data64;					//!< message data as
		s8_t			Data8s[8];				//!< message data as byte array
		s16_t			Data16s[4];				//!< message data as word array
		s32_t			Data32s[2];				//!< message data as dword array
		float			DataFlt[2];				//!< message data as float
		double			DataDbl;				//!< message data as double
	}Data;
} CANMsg_t;
