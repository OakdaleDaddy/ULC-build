...
namespace Weco.CAN
{
   ...
   public class Device
   {
     ...
     // private byte nodeId;
      ...
      protected virtual void EvaluateReceiveTrace(int cobId, byte[] msg, ref bool traced)
      {
      ...
      protected void TraceReceive(COBTypes frameType, int cobId, byte[] msg)
      {
         bool trace = false;
      ...
      public void Update(int cobId, byte[] msg, ref bool traced)
      {
         ...
         this.EvaluateReceiveTrace(cobId, msg, ref traced);
