namespace Weco.Ui
{
   partial class TargetRobotMovementSetupForm
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.MaxSpeedValueButton = new Controls.ValueButton();
         this.LowSpeedScaleValueButton = new Controls.ValueButton();
         this.WheelDrivePanel = new Controls.TransparentPanel();
         this.RearDirectionToggleButton = new Controls.ValueToggleButton();
         this.FrontDirectionToggleButton = new Controls.ValueToggleButton();
         this.RearStateCycleButton = new Controls.ValueCycleButton();
         this.transparentLabel1 = new Controls.TransparentLabel();
         this.FrontStateCycleButton = new Controls.ValueCycleButton();
         this.RearPanel = new Controls.BorderedPanel();
         this.label6 = new System.Windows.Forms.Label();
         this.FrontPanel = new Controls.BorderedPanel();
         this.label1 = new System.Windows.Forms.Label();
         this.TitleLabel = new System.Windows.Forms.Label();
         this.BackButton = new Controls.BaseButton();
         this.ActuationModeButton = new Controls.ValueToggleButton();
         ...
         this.MainPanel.Controls.Add(this.ActuationModeButton);
         ...
         this.MainPanel.Size = new System.Drawing.Size(451, 430);
         ...
         this.MaxSpeedValueButton.Location = new System.Drawing.Point(317, 75);
         ...
         this.MaxSpeedValueButton.Size = new System.Drawing.Size(107, 80);
         ...
         this.LowSpeedScaleValueButton.Location = new System.Drawing.Point(317, 163);
         ...
         this.LowSpeedScaleValueButton.Size = new System.Drawing.Size(107, 80);
         ...
         this.RearStateCycleButton.HoldTimeout += new Controls.ValueCycleButton.HoldTimeoutHandler(this.RearStateCycleButton_HoldTimeout);
         this.RearStateCycleButton.SelectionTimeout += new Controls.ValueCycleButton.SelectionTimeoutHandler(this.RearStateCycleButton_SelectionTimeout);
         ...
         this.FrontStateCycleButton.HoldTimeout += new Controls.ValueCycleButton.HoldTimeoutHandler(this.FrontStateCycleButton_HoldTimeout);
         this.FrontStateCycleButton.SelectionTimeout += new Controls.ValueCycleButton.SelectionTimeoutHandler(this.FrontStateCycleButton_SelectionTimeout);
         ...
         this.BackButton.Location = new System.Drawing.Point(183, 347);
         ...
         // ActuationModeButton
         // 
         this.ActuationModeButton.AutomaticToggle = true;
         this.ActuationModeButton.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(171)))), ((int)(((byte)(171)))), ((int)(((byte)(171)))));
         this.ActuationModeButton.DisabledBackColor = System.Drawing.Color.Black;
         this.ActuationModeButton.DisabledForeColor = System.Drawing.Color.Gray;
         this.ActuationModeButton.DisabledOptionBackColor = System.Drawing.Color.Black;
         this.ActuationModeButton.Font = new System.Drawing.Font("Microsoft Sans Serif", 11.25F, System.Drawing.FontStyle.Bold);
         this.ActuationModeButton.HoldArrorColor = System.Drawing.Color.Gray;
         this.ActuationModeButton.HoldEnable = false;
         this.ActuationModeButton.HoldTimeoutInterval = 0;
         this.ActuationModeButton.Location = new System.Drawing.Point(317, 251);
         this.ActuationModeButton.Name = "ActuationModeButton";
         this.ActuationModeButton.OptionASelected = true;
         this.ActuationModeButton.OptionAText = "CLOSED LOOP";
         this.ActuationModeButton.OptionBSelected = false;
         this.ActuationModeButton.OptionBText = "OPEN LOOP";
         this.ActuationModeButton.OptionCenterWidth = 0;
         this.ActuationModeButton.OptionEdgeHeight = 8;
         this.ActuationModeButton.OptionHeight = 25;
         this.ActuationModeButton.OptionNonSelectedBackColor = System.Drawing.Color.Black;
         this.ActuationModeButton.OptionNonSelectedFont = new System.Drawing.Font("Microsoft Sans Serif", 6.75F);
         this.ActuationModeButton.OptionNonSelectedForeColor = System.Drawing.SystemColors.ControlDark;
         this.ActuationModeButton.OptionSelectedBackColor = System.Drawing.Color.Lime;
         this.ActuationModeButton.OptionSelectedFont = new System.Drawing.Font("Microsoft Sans Serif", 6.75F, System.Drawing.FontStyle.Bold);
         this.ActuationModeButton.OptionSelectedForeColor = System.Drawing.Color.Black;
         this.ActuationModeButton.OptionWidth = 50;
         this.ActuationModeButton.Size = new System.Drawing.Size(107, 80);
         this.ActuationModeButton.TabIndex = 212;
         this.ActuationModeButton.Text = "FORWARD CONTROL";
         this.ActuationModeButton.UseVisualStyleBackColor = false;
         this.ActuationModeButton.Click += new System.EventHandler(this.ActuationModeButton_Click);
         // 
         ...
         this.Shown += new System.EventHandler(this.TargetRobotMovementSetupForm_Shown);
      ...
      private Controls.ValueToggleButton ActuationModeButton;
   }
}