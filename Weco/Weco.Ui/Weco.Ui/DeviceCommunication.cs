...
namespace Weco.Ui
{
   ...
   public class DeviceCommunication
   {
      ...
      {
         LaserCommunicationBus.Instance.StopLaserLeftStepper();
      }

      public void SetLaserLeftStepperTargetPosition(int position)
      {
         LaserCommunicationBus.Instance.SetLaserLeftStepperTargetPosition(position);
      }

      public int GetLaserLeftStepperTargetPosition()
      {
         return (LaserCommunicationBus.Instance.GetLaserLeftStepperTargetPosition());
      }

      public int GetLaserLeftStepperPosition()
      {
         return (LaserCommunicationBus.Instance.GetLaserLeftStepperPosition());
      }

      public bool GetLaserLeftStepperHomeSwitchActive()
      {
         return (LaserCommunicationBus.Instance.GetLaserLeftStepperHomeSwitchActive());
      }
      ...
      {
         LaserCommunicationBus.Instance.StopLaserRightStepper();
      }

      public void SetLaserRightStepperTargetPosition(int position)
      {
         LaserCommunicationBus.Instance.SetLaserRightStepperTargetPosition(position);
      }

      public int GetLaserRightStepperTargetPosition()
      {
         return (LaserCommunicationBus.Instance.GetLaserRightStepperTargetPosition());
      }

      public int GetLaserRightStepperPosition()
      {
         return (LaserCommunicationBus.Instance.GetLaserRightStepperPosition());
      }

      public bool GetLaserRightStepperHomeSwitchActive()
      {
         return (LaserCommunicationBus.Instance.GetLaserRightStepperHomeSwitchActive());
      }
      ...
      {
         return (TargetCommunicationBus.Instance.GetTopCameraStepperHomeSwitchActive());
      }
