   ...
   public partial class TargetRobotMovementSetupForm : Form
   {
      ...
      private void FrontStateCycleButton_HoldTimeout(object sender, Controls.HoldTimeoutEventArgs e)
      {
         if (false == this.FrontStateCycleButton.SelectionTimedOut)
         {
            ...
            this.SetMovementMotorState(ParameterAccessor.Instance.TargetFrontWheel, selectedOption);
            this.ShowMotorState(this.FrontStateCycleButton, ParameterAccessor.Instance.TargetFrontWheel.MotorState, true);
            e.Handled = true;
         }
      }
      ...
      {
         this.ShowMotorState(this.FrontStateCycleButton, ParameterAccessor.Instance.TargetFrontWheel.MotorState, false);
      }
      ...
      private void RearStateCycleButton_HoldTimeout(object sender, Controls.HoldTimeoutEventArgs e)
      {
         if (false == this.RearStateCycleButton.SelectionTimedOut)
         {
            ...
            this.SetMovementMotorState(ParameterAccessor.Instance.TargetRearWheel, selectedOption);
            this.ShowMotorState(this.RearStateCycleButton, ParameterAccessor.Instance.TargetRearWheel.MotorState, true);
            e.Handled = true;
         }
      }
      ...
      {
         this.ShowMotorState(this.RearStateCycleButton, ParameterAccessor.Instance.TargetRearWheel.MotorState, false);
      }
      ...
      private void ActuationModeButton_Click(object sender, EventArgs e)
      {
         ...
         ParameterAccessor.Instance.TargetFrontWheel.ActuationMode = (false != selected) ? ActuationModes.closedloop : ActuationModes.openloop;
         ParameterAccessor.Instance.TargetRearWheel.ActuationMode = (false != selected) ? ActuationModes.closedloop : ActuationModes.openloop;
      }
      ...
      {
         this.SetMovementButtons(this.FrontStateCycleButton, this.FrontDirectionToggleButton, ParameterAccessor.Instance.TargetFrontWheel);
         this.SetMovementButtons(this.RearStateCycleButton, this.RearDirectionToggleButton, ParameterAccessor.Instance.TargetRearWheel);
         ...
         this.ActuationModeButton.OptionASelected = (ActuationModes.closedloop == ParameterAccessor.Instance.TargetFrontWheel.ActuationMode) ? true : false;
      }
