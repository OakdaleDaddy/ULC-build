...
namespace Weco.Ui.Controls
{
   ...
   public class CameraSelectButton : Button
   {
      ...
      public bool CenterEnabled { set; get; }

      public bool CenterVisible
      {
         set
         {
            if (false != this.CenterEnabled)
            {
      ...
      protected override void OnPaint(PaintEventArgs e)
      {
         ...
         e.Graphics.DrawString(this.Text, this.Font, new SolidBrush(foreColor), textRect, textFormat);
      }
      ...
      public CameraSelectButton()
      {
         ...
         base.MouseUp += this.CameraSelectButton_MouseUp;
