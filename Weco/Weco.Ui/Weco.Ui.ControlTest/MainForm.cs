...
namespace E4.Ui.ControlTest
{
   public partial class MainForm : Form
   {
      ...
      #region Roll Indicator Events

      private void RollTrackBar_Scroll(object sender, EventArgs e)
      {
         this.TestRollDisplay.Roll = this.RollTrackBar.Value;
      }

      private void PositionRollTrackBar_Scroll(object sender, EventArgs e)
      {
         this.TestRollDisplay.PositionRoll = this.PositionRollTrackBar.Value;
      }      
