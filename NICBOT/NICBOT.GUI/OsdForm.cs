...
namespace NICBOT.GUI
{
   public partial class OsdForm : Form
   {
         ...
         if ("\n" == ch)
         {
            ...
            if (this.OsdRichTextBox.Lines.Length > 0)
            {
               ...
               if ((offsetIntoLine != currentLineText.Length) ||
                   (5 == this.OsdRichTextBox.Lines.Length))
               {
      ...
      {
         bool selection = !this.TimeToggleButton.CenterVisible;
         this.TimeToggleButton.CenterVisible = selection;
         ParameterAccessor.Instance.Osd.ShowTime = selection;
         VideoStampOsd.Instance.SetTimeVisible(selection);
      }

      private void DateToggleButton_Click(object sender, EventArgs e)
      {
         bool selection = !this.DateToggleButton.CenterVisible;
         this.DateToggleButton.CenterVisible = selection;
         ParameterAccessor.Instance.Osd.ShowDate = selection;
         VideoStampOsd.Instance.SetDateVisible(selection);
      }

      private void CameraIdToggleButton_Click(object sender, EventArgs e)
      {
         bool selection = !this.CameraIdToggleButton.CenterVisible;
         this.CameraIdToggleButton.CenterVisible = selection;
         ParameterAccessor.Instance.Osd.ShowCameraId = selection;
         VideoStampOsd.Instance.SetCameraIdVisible(selection);
      }

      private void DescriptionToggleButton_Click(object sender, EventArgs e)
      {
         bool selection = !this.DescriptionToggleButton.CenterVisible;
         this.DescriptionToggleButton.CenterVisible = selection;
         ParameterAccessor.Instance.Osd.ShowDescription = selection;
         VideoStampOsd.Instance.SetDescriptionVisible(selection);
      }

      private void PipeDisplacmentToggleButton_Click(object sender, EventArgs e)
      {
         bool selection = !this.PipeDisplacmentToggleButton.CenterVisible;
         this.PipeDisplacmentToggleButton.CenterVisible = selection;
         ParameterAccessor.Instance.Osd.ShowPipeDisplacement = selection;
         VideoStampOsd.Instance.SetPipeDisplacementVisible(selection);
      }

      private void PipePositionToggleButton_Click(object sender, EventArgs e)
      {
         bool selection = !this.PipePositionToggleButton.CenterVisible;
         this.PipePositionToggleButton.CenterVisible = selection;
         ParameterAccessor.Instance.Osd.ShowPipePosition = selection;
         VideoStampOsd.Instance.SetPipePositionVisible(selection);
      }
      ...
      private void OsdForm_Shown(object sender, EventArgs e)
      {
         ...
         this.DateToggleButton.CenterVisible = ParameterAccessor.Instance.Osd.ShowDate;
         this.TimeToggleButton.CenterVisible = ParameterAccessor.Instance.Osd.ShowTime;
         this.CameraIdToggleButton.CenterVisible = ParameterAccessor.Instance.Osd.ShowCameraId;
         this.DescriptionToggleButton.CenterVisible = ParameterAccessor.Instance.Osd.ShowDescription;
         this.PipeDisplacmentToggleButton.CenterVisible = ParameterAccessor.Instance.Osd.ShowPipeDisplacement;
         this.PipePositionToggleButton.CenterVisible = ParameterAccessor.Instance.Osd.ShowPipePosition;
      ...
      private void ScreenVeriticalOffsetIncreaseButton_Click(object sender, EventArgs e)
      {
         VideoStampOsd.Instance.IncreaseVeriticalOffset(ParameterAccessor.Instance.Osd);
      }

      private void ScreenVeriticalOffsetDecreaseButton_Click(object sender, EventArgs e)
      {
         VideoStampOsd.Instance.DecreaseVeriticalOffset(ParameterAccessor.Instance.Osd);
      }

      private void ScreenHorizontalOffsetDecreaseButton_Click(object sender, EventArgs e)
      {
         VideoStampOsd.Instance.DecreaseHorizontalOffset(ParameterAccessor.Instance.Osd);
      }

      private void ScreenHorizontalOffsetIncreaseButton_Click(object sender, EventArgs e)
      {
         VideoStampOsd.Instance.IncreaseHorizontalOffset(ParameterAccessor.Instance.Osd);
      }
