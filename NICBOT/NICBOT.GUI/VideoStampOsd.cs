...
namespace NICBOT.GUI
{
   ...
   public class VideoStampOsd
   {
      ...
      public void Configure(OsdParameters osdParameters)
      {
         ...
         this.SetScreenHorizontalPositionOffset(osdParameters.HozizontalOffset);
         ...
         Thread.Sleep(50);
         this.SetPipeDisplacementVisible(osdParameters.ShowPipeDisplacement);
         Thread.Sleep(50);
         this.SetPipePositionVisible(osdParameters.ShowPipePosition);
         Thread.Sleep(50);
      ...
      {
         if (osdParameters.HozizontalOffset > 0)
         {
            osdParameters.HozizontalOffset--;
            this.SetScreenHorizontalPositionOffset(osdParameters.HozizontalOffset);
         }
      }
      ...
      {
         if (osdParameters.HozizontalOffset < 63)
         {
            osdParameters.HozizontalOffset++;
            this.SetScreenHorizontalPositionOffset(osdParameters.HozizontalOffset);
         }
