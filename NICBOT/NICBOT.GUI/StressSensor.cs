namespace NICBOT.GUI
{
   ...
   public class StressSensor
   {
      ...
      private static StressSensor instance = null;
      ...
      public static StressSensor Instance
      {
         get
         {
            if (null == instance)
            {
               instance = new StressSensor();
               instance.Initialize();
            }
      ...
      public void Start(string address, int port)
      {
             ...
             (0 != port))
         {
            ...
            this.thread.Name = "Stress Sensor";
