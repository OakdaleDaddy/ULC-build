...
namespace NICBOT.GUI
{
   public class ValueCycleButton : Button
   {
      ...
      protected override void OnPaint(PaintEventArgs e)
      {
         ...
         Color enabledOptionABackTextColor = (1 == this.SelectedOption) ? this.OptionSelectedBackColor : this.OptionNonSelectedBackColor;
         ...
         Color optionATextColor = (1 == this.SelectedOption) ? this.OptionSelectedForeColor : this.OptionNonSelectedForeColor;
         ...
         Color enabledOptionBBackTextColor = (2 == this.SelectedOption) ? this.OptionSelectedBackColor : this.OptionNonSelectedBackColor;
         ...
         Color optionBTextColor = (2 == this.SelectedOption) ? this.OptionSelectedForeColor : this.OptionNonSelectedForeColor;
         ...
         Color enabledOptionCBackTextColor = (3 == this.SelectedOption) ? this.OptionSelectedBackColor : this.OptionNonSelectedBackColor;
         ...
         Color optionCTextColor = (3 == this.SelectedOption) ? this.OptionSelectedForeColor : this.OptionNonSelectedForeColor;
         ...
         int textTop = this.OptionEdgeSpace + (this.OptionHeight * 3) + (this.OptionOptionSpace * 2) + pressOffset;
