...
namespace NICBOT.Controls
{
   public class ValueButton : Button
   {
      ...
      public Color ValueForeColor
      {
         set
         {
            this._valueForeColor = value;
            this.Invalidate();
         }

         get
         {
            return (this._valueForeColor);
         }
      }
      ...
      public int ValueEdgeHeight
      {
         set
         {
            this._valueEdgeHeight = value;
            this.Invalidate();
         }

         get
         {
            return (this._valueEdgeHeight);
         }
      }
         ...
         : base()
      {
         ...
         this.ValueEdgeHeight = 5;
         this.ValueHeight = this.ValueFont.Height;
         this.ValueWidth = this.Width - 6;
