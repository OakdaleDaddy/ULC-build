...
{
   partial class UlcRoboticsNicbotWheel
   {
      /// <summary> 
      ...
      private void InitializeComponent()
      {
         ...
         // InputsTextBox
         // 
         this.InputsTextBox.Location = new System.Drawing.Point(374, 4);
         this.InputsTextBox.MaxLength = 2;
         this.InputsTextBox.Name = "InputsTextBox";
         this.InputsTextBox.Size = new System.Drawing.Size(25, 20);
         this.InputsTextBox.TabIndex = 143;
         this.InputsTextBox.Text = "00";
         ...
         this.ControlWordTextBox.TabIndex = 145;
         ...
         this.StatusTextBox.TabIndex = 147;
         ...
         this.DisplayModeTextBox.TabIndex = 151;
         ...
         this.VelocityTargetTextBox.TabIndex = 152;
         ...
         this.label6.Text = "VELOCITY TARGET";
         ...
         this.label7.Text = "VELOCITY ACTUAL";
         ...
         this.VelocityActualTextBox.TabIndex = 155;
         ...
         this.VelocityAccelerationTextBox.TabIndex = 156;
         ...
         this.label8.Text = "VELOCITY ACCELERATION";
         ...
         this.label9.Text = "VELOCITY DECELERATION";
         ...
         this.VelocityDecelerationTextBox.TabIndex = 159;
         ...
         this.TorqueTargetTextBox.TabIndex = 160;
         this.TorqueTargetTextBox.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
         // 
         // label11
         // 
         this.label11.AutoSize = true;
         this.label11.Location = new System.Drawing.Point(457, 56);
         this.label11.Name = "label11";
         this.label11.Size = new System.Drawing.Size(100, 13);
         this.label11.TabIndex = 161;
         this.label11.Text = "TORQUE TARGET";
         ...
         this.ProducerHeartbeatTimeTextBox.TabIndex = 168;
         ...
         this.ConsumerHeartbeatTimeTextBox.TabIndex = 169;
         ...
         this.ErrorCodeTextBox.TabIndex = 171;
         ...
         this.ErrorStatusTextBox.TabIndex = 173;
         ...
         this.MotorRatedTorqueTextBox.TabIndex = 174;
         ...
         this.TorqueSlopeTextBox.TabIndex = 177;
         ...
         this.MaximumTorqueTextBox.TabIndex = 180;
         ...
         this.MaximumCurrentTextBox.TabIndex = 178;
