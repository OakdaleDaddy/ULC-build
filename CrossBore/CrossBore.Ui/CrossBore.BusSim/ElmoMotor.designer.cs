...
namespace CrossBore.BusSim
{
   partial class ElmoMotor
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.UnderVoltageButton = new System.Windows.Forms.Button();
         this.SuspendLayout();
         // 
         // NodeIdTextBox
         // 
         ...
         // UnderVoltageButton
         // 
         this.UnderVoltageButton.Location = new System.Drawing.Point(789, 168);
         this.UnderVoltageButton.Name = "UnderVoltageButton";
         this.UnderVoltageButton.Size = new System.Drawing.Size(75, 34);
         this.UnderVoltageButton.TabIndex = 212;
         this.UnderVoltageButton.Text = "Under Voltage";
         this.UnderVoltageButton.UseVisualStyleBackColor = true;
         this.UnderVoltageButton.Click += new System.EventHandler(this.UnderVoltageButton_Click);
         // 
         // ElmoMotor
         // 
         ...
         this.Controls.Add(this.UnderVoltageButton);
         ...
         this.Name = "ElmoMotor";
         this.Size = new System.Drawing.Size(884, 210);
      ...
      private System.Windows.Forms.Button UnderVoltageButton;
   }
}
