...
namespace CrossBore.BusSim
{
   ...
   public partial class UlcRoboticsWekoTrackController : DeviceControl
   {
      #region Fields
      ...
      public UlcRoboticsWekoTrackController()
      {
         this.InitializeComponent();

         this.deviceType = 0xFFFF0191;
         this.ErrorRegister = 0;
         this.manufacturerDeviceName = "Weko Track Controller";
