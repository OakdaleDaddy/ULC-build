...
{
   partial class UlcRoboticsWekoTrackController
   {
      /// <summary> 
      ...
      private void InitializeComponent()
      {
         ...
         this.TrackMotor = new CrossBore.BusSim.BldcMotor();
         ...
         // 
         // UlcRoboticsWekoTrackController
         // 
         ...
         this.Name = "UlcRoboticsWekoTrackController";
