...
namespace CrossBore.BusSim
{
   ...
   public partial class UlcRoboticsWekoHubController : DeviceControl
   {
      #region Fields
      ...
      private UInt32 imuConfiguration;
      private UInt16 imuAxisRemap;
      private byte imuUnitSelection;
      private UInt16 imuUpdateFrequency;
      private byte imuCalibrationStatus;
      private Int16 imuXValue;
      private Int16 imuYValue;
      private Int16 imuZValue;
      private byte imuTemperature;
      private byte imuErrorTemperature;

      private byte mcuTemperature;
      private byte mcuErrorTemperature;
      private byte dcLinkVoltageByte;
      private byte railCurrentByte;
      ...
      private UInt32 ManufacturerStatusRegister
      {
         set
         {
            this.SetValue(0x1002, 0x00, this.ManufacturerStatusRegisterLabel, "Manufacturer Status Register", ref this.manufacturerStatusRegister, value, 8);
         }
      ...
      private UInt32 PredefinedError1
      {
         set
         {
            this.SetValue(0x1003, 0x01, this.PredefinedErrorField1Label, "Pre-defined Error Field 1", ref this.predefinedError1, value, 8);
         }
      ...
      private UInt32 PredefinedError2
      {
         set
         {
            this.SetValue(0x1003, 0x02, this.PredefinedErrorField2Label, "Pre-defined Error Field 2", ref this.predefinedError2, value, 8);
         }
      ...
      private UInt32 PredefinedError3
      {
         set
         {
            this.SetValue(0x1003, 0x03, this.PredefinedErrorField3Label, "Pre-defined Error Field 3", ref this.predefinedError3, value, 8);
         }
      ...
      private UInt32 PredefinedError4
      {
         set
         {
            this.SetValue(0x1003, 0x04, this.PredefinedErrorField4Label, "Pre-defined Error Field 4", ref this.predefinedError4, value, 8);
         }
      ...
      private UInt32 CommunicationCyclePeriod
      {
         set
         {
            this.SetValue(0x1006, 0x00, this.CommunicationCyclePeriodLabel, "Communication Cycle Period", ref this.communicationCyclePeriod, value, 8);
         }
      ...
      private UInt32 SynchronousWindowLength
      {
         set
         {
            this.SetValue(0x1007, 0x00, this.SynchronousWindowLengthLabel, "Synchronous Window Length", ref this.synchronousWindowLength, value, 8);
         }
      ...
      private UInt16 GuardTime
      {
         set
         {
            this.SetValue(0x100C, 0x00, this.GuardTimeLabel, "Guard Time", ref this.guardTime, value, 4);
         }
      ...
      private byte LifeTimeFactor
      {
         set
         {
            this.SetValue(0x100D, 0x00, this.LifeTimeFactorLabel, "Life Time Factor", ref this.lifeTimeFactor, value, 2);
         }
      ...
      private UInt16 EmergencyInhibitTime
      {
         set
         {
            this.SetValue(0x1015, 0x00, this.EmergencyInhibitTimeLabel, "Emergency Inhibit Time", ref this.emergencyInhibitTime, value, 4);
         }
      ...
      private UInt16 LedIntensity1
      {
         set
         {
            this.SetValue(0x2303, 0x01, this.LedIntensity1Label, "LED 1 Intensity", ref this.ledIntensity1, value, 4);
         }

         get
         {
            return (this.ledIntensity1);
         }
      }
      ...
      private UInt16 LedIntensity2
      {
         set
         {
            this.SetValue(0x2303, 0x02, this.LedIntensity2Label, "LED 2 Intensity", ref this.ledIntensity2, value, 4);
         }

         get
         {
            return (this.ledIntensity2);
         }
      }
      ...
      private UInt32 ImuConfiguration
      {
         set
         {
            this.SetValue(0x2440, 0x01, this.ImuConfigurationLabel, "IMU Configuration", ref this.imuConfiguration, value, 8);
         }

         get
         {
            return (this.imuConfiguration);
         }
      }
      ...
      private UInt16 ImuAxisRemap
      {
         set
         {
            this.SetValue(0x2440, 0x02, this.ImuAxisRemapLabel, "IMU Axis Remap", ref this.imuAxisRemap, value, 4);
         }

         get
         {
            return (this.imuAxisRemap);
         }
      }
      ...
      private byte ImuUnitSelection
      {
         set
         {
            this.SetValue(0x2440, 0x03, this.ImuUnitSelectionLabel, "IMU Unit Selection", ref this.imuUnitSelection, value, 2);
         }

         get
         {
            return (this.imuUnitSelection);
         }
      }
      ...
      private UInt16 ImuUpdateFrequency
      {
         set
         {
            this.SetValue(0x2440, 0x04, this.ImuUpdateFrequencyLabel, "IMU Update Frequency", ref this.imuUpdateFrequency, value, 4);
         }
      ...
      private byte ImuCalibrationStatus
      {
         set
         {
            this.SetValue(0x2440, 0x05, this.ImuCalibrationStatusLabel, "IMU Calibration Status", ref this.imuCalibrationStatus, value, 2);
         }

         get
         {
            return (this.imuCalibrationStatus);
         }
      }
      ...
      private Int16 ImuXValue
      {
         set
         {
            this.SetValue(0x2441, 0x01, this.ImuXValueLabel, "IMU X Value", ref this.imuXValue, value, 4);
         }

         get
         {
            return (this.imuXValue);
         }
      }
      ...
      private Int16 ImuYValue
      {
         set
         {
            this.SetValue(0x2441, 0x02, this.ImuYValueLabel, "IMU Y Value", ref this.imuYValue, value, 4);
         }

         get
         {
            return (this.imuYValue);
         }
      }
      ...
      private Int16 ImuZValue
      {
         set
         {
            this.SetValue(0x2441, 0x03, this.ImuZValueLabel, "IMU Z Value", ref this.imuZValue, value, 4);
         }

         get
         {
            return (this.imuZValue);
         }
      }
      ...
      private byte ImuTemperature
      {
         set
         {
            this.SetValue(0x2446, 0x01, this.ImuTemperatureLabel, "IMU Temperature", ref this.imuTemperature, value, 2);
         }
      ...
      private byte ImuErrorTemperature
      {
         set
         {
            this.SetValue(0x2443, 0x02, this.ImuTemperatureLabel, "IMU Error Temperature", ref this.imuErrorTemperature, value, 2);
         }

         get
         {
            return (this.imuErrorTemperature);
         }
      }
      ...
      private byte DcLinkVoltageByte
      {
         set
         {
            this.SetValue(0x2000, 0x00, this.DcLinkVoltageByteLabel, "DC Link Voltage Byte", ref this.dcLinkVoltageByte, value, 2);
         }
      ...
      private byte RailCurrentByte
      {
         set
         {
            this.SetValue(0x2001, 0x00, this.RailCurrentByteLabel, "Rail Current Byte", ref this.railCurrentByte, value, 2);
         }

         get
         {
            return (this.railCurrentByte);
         }
      }
      ...
      private byte Outputs
      {
         set
         {
            this.SetValue(0x6200, 0x01, this.OutputsLabel, "Outputs", ref this.outputs, value, 2);
         }
      ...
      protected void Reset(bool fromPowerUp)
      {
         if (false != this.active)
         {
            ...
            this.ImuConfiguration = 0;
            this.ImuAxisRemap = 0x24;
            this.ImuUnitSelection = 0;
            this.ImuUpdateFrequency = 10;
            this.ImuCalibrationStatus = 0;
            this.ImuErrorTemperature = 1;

            this.McuErrorTemperature = 0;
            this.DcLinkVoltageByte = 0;
            this.RailCurrentByte = 0;
      ...
      protected override bool LoadDeviceData(UInt16 index, byte subIndex, byte[] buffer, ref UInt32 dataLength)
      {
         ...
         else if (0x2001 == index)
         {
            dataLength = this.MoveDeviceData(buffer, this.RailCurrentByte);
            valid = true;
         }
         #region IMU
         ...
         {
            dataLength = this.MoveDeviceData(buffer, this.ImuConfiguration);
            valid = true;
         }
         else if ((0x2440 == index) && (0x02 == subIndex))
         {
            dataLength = this.MoveDeviceData(buffer, this.ImuAxisRemap);
            valid = true;
         }
         else if ((0x2440 == index) && (0x03 == subIndex))
         {
            dataLength = this.MoveDeviceData(buffer, this.ImuUnitSelection);
            valid = true;
         }
         else if ((0x2440 == index) && (0x04 == subIndex))
         {
            dataLength = this.MoveDeviceData(buffer, this.ImuUpdateFrequency);
            valid = true;
         }
         else if ((0x2440 == index) && (0x05 == subIndex))
         {
            dataLength = this.MoveDeviceData(buffer, this.ImuCalibrationStatus);
            valid = true;
         }
         ...
         {
            dataLength = this.MoveDeviceData(buffer, this.ImuXValue);
            valid = true;
         }
         else if ((0x2441 == index) && (0x02 == subIndex))
         {
            dataLength = this.MoveDeviceData(buffer, this.ImuYValue);
            valid = true;
         }
         else if ((0x2441 == index) && (0x03 == subIndex))
         {
            dataLength = this.MoveDeviceData(buffer, this.ImuZValue);
            valid = true;
         }
         ...
         {
            dataLength = this.MoveDeviceData(buffer, this.ImuTemperature);
            valid = true;
         }
         else if ((0x2443 == index) && (0x02 == subIndex))
         {
            dataLength = this.MoveDeviceData(buffer, this.ImuErrorTemperature);
            valid = true;
         }
         #endregion
         ...
         #endregion
         #region Outputs
         else if ((0x6200 == index) && (0x00 == subIndex))
         {
            dataLength = this.MoveDeviceData(buffer, (byte)1);
            valid = true;
         }
         else if ((0x6200 == index) && (0x01 == subIndex))
         {
      ...
      protected override bool StoreDeviceData(UInt16 index, byte subIndex, byte[] buffer, int offset, UInt32 length)
      {
         ...
         {
            this.ImuConfiguration = BitConverter.ToUInt32(buffer, offset);
            valid = true;
         }
         else if ((0x2440 == index) && (0x02 == subIndex) && (2 == length))
         {
            ...
            {
               this.ImuAxisRemap = value;
               valid = true;
            }
         }
         else if ((0x2440 == index) && (0x03 == subIndex) && (1 == length))
         {
            this.ImuUnitSelection = buffer[offset];
            valid = true;
         }
         else if ((0x2440 == index) && (0x04 == subIndex) && (2 == length))
         {
            this.ImuUpdateFrequency = BitConverter.ToUInt16(buffer, offset);
            valid = true;
         }
         else if ((0x2443 == index) && (0x02 == subIndex) && (1 == length))
         {
            this.ImuErrorTemperature = buffer[offset];
            valid = true;
         }
         #endregion
         #region Sub System Status
         ...
         #endregion
         #region Outputs
         else if ((0x6200 == index) && (0x01 == subIndex) && (1 == length))
         {
            this.Outputs = buffer[offset];
            valid = true;
         }
         #endregion
      ...
      private void SetRailCurrentByteButton_Click(object sender, EventArgs e)
      {
         byte railCurrentByte = 0;

         if (byte.TryParse(this.RailCurrentByteTextBox.Text, out railCurrentByte) != false)
         {
            this.RailCurrentByte = railCurrentByte;
         }
      }

      private void SetImuButton_Click(object sender, EventArgs e)
      {
         Int16 imuX = 0;
         Int16 imuY = 0;
         Int16 imuZ = 0;

         if ((Int16.TryParse(this.ImuXTextBox.Text, out imuX) != false) &&
             (Int16.TryParse(this.ImuYTextBox.Text, out imuY) != false) &&
             (Int16.TryParse(this.ImuZTextBox.Text, out imuZ) != false))
         {
            this.ImuXValue = imuX;
            this.ImuYValue = imuY;
            this.ImuZValue = imuZ;
      ...
      public UlcRoboticsWekoHubController()
      {
         this.InitializeComponent();

         this.deviceType = 0xFFFF0191;
         this.ErrorRegister = 0;
         this.manufacturerDeviceName = "Weko Hub";
