...
namespace UlcRobotics.Ui.Controls
{
   ...
   public class BaseButton : Button
   {
      ...
      private bool DecodeTouch(ref Message m)
      {
         ...
         {
            TouchedObject.Instance.TouchDown(this);
         ...
         {
            // system generates WM_LBUTTONDOWN and WM_LBUTTONUP messages when screen is released
            result = true;
         }
      ...
      protected override void WndProc(ref Message m)
      {
         ...
         {
            if (TouchedObject.Instance.ButtonDownExpected(this) == false)
            {
               handled = true;
               process = false;
            }
         }
         else if (WM_LBUTTONUP == m.Msg)
         {
            if (TouchedObject.Instance.ButtonUpExpected(this) == false)
            {
               handled = true;
               process = false;
            }
