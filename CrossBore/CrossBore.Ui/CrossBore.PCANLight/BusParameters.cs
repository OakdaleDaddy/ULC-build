...
namespace CrossBore.PCANLight
{
   ...
   {
      public int BitRate { set; get; }
      public bool UseNodeId { set; get; }
      public int NodeId { set; get; }

      public UsbBusParameters(BusInterfaces busInterface, int bitRate, bool useNodeId, int nodeId, FramesType messageType, TraceGroup traceGroup, ReceiveDelegateHandler receiveHandler)
         : base(busInterface, messageType, traceGroup, receiveHandler)
      {
         this.BitRate = bitRate;
