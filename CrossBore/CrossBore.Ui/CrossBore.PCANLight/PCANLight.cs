...
namespace CrossBore.PCANLight
{
   ...
   public enum HardwareType : int
   {
      ...
      DNP = 8,		      // DONGLE PRO
      DNG = 9,		      // DONGLE
      IPGW_1CH = 10,    // IP Gateway 1st Channel
      IPGW_2CH = 11,    // IP Gateway 2nd Channel
   }
   ...
   public class TCLightMsg
   {
      ...
      /// TCLightMsg constructor
      /// </summary>
      /// <param name="Msg">A TCANMsg structure defined in the IpGateway Class</param>
      public TCLightMsg(IpGateway.TPCANMsg Msg)
      {
         ID = Msg.ID;
         MsgType = (MsgTypes)Msg.MSGTYPE;
         Len = Msg.LEN;
      ...
      /// <summary>
      /// Overloaded Type Casting to a TCANMsg structure defined in the IpGateway class
      /// </summary>
      /// <param name="Msg">Instance of the TCLightMsg Class to cast</param>
      /// <returns>A corresponding TCANMsg structure, defined in IpGateway Class</returns>
      public static implicit operator IpGateway.TPCANMsg(TCLightMsg Msg)
      {
         IpGateway.TPCANMsg toReturn;
   ...
   public class TCLightTimestamp
   {
      ...
      /// TCLightTimestamp constructor
      /// </summary>
      /// <param name="RcvTime">A TPCANTimestamp structure defined in the IpGateway Class</param>
      public TCLightTimestamp(IpGateway.TPCANTimestamp RcvTime)
      {
         millis = RcvTime.millis;
         millis_overflow = RcvTime.millis_overflow;
         micros = RcvTime.micros;
      ...
      /// <summary>
      /// Overloaded Type Casting to a TPCANTimestamp structure defined in the IpGateway class
      /// </summary>
      /// <param name="RcvTime">Instance of the TCLightTimestamp Class to cast</param>
      /// <returns>A corresponding TPCANTimestamp structure, defined in IpGateway Class</returns>
      public static implicit operator IpGateway.TPCANTimestamp(TCLightTimestamp RcvTime)
      {
         IpGateway.TPCANTimestamp toReturn;

         toReturn = new IpGateway.TPCANTimestamp();
         toReturn.millis = RcvTime.millis;
         toReturn.millis_overflow = RcvTime.millis_overflow;
         toReturn.micros = RcvTime.micros;
   ...
   public class PCANLight
   {
      ...
      /// <summary>
      /// PCANLight Init function for IP Wireless Gateway Hardware.  
      /// This function make the following:
      ///		- Call init function.
      /// </summary>
      /// <param name="HWType">Which hardware should be initialized</param>
      /// <param name="MsgType">If the frame type is standard or extended</param>
      /// <param name="TransmitEndPoint">IP endpoint to sent to</param>
      /// <param name="ReceiveEndPoint">IP endpoint to receive from</param>
      /// <returns>A CANResult value - Error/status of the hardware after execute the function</returns>
      public static CANResult Init(HardwareType HWType, FramesType MsgType, IPEndPoint TransmitEndPoint, IPEndPoint ReceiveEndPoint)
      {
         try
         {
            switch (HWType)
            {
               case HardwareType.IPGW_1CH:
                  return (CANResult)IpGateway.IPGW1.Init((int)MsgType, TransmitEndPoint, ReceiveEndPoint);

               case HardwareType.IPGW_2CH:
                  return (CANResult)IpGateway.IPGW2.Init((int)MsgType, TransmitEndPoint, ReceiveEndPoint);
      ...
      public static CANResult Close(HardwareType HWType)
      {
         try
         {
            switch (HWType)
            {
               ...
               case HardwareType.IPGW_1CH:
                  return (CANResult)IpGateway.IPGW1.Close();
                  
               case HardwareType.IPGW_2CH:
                  return (CANResult)IpGateway.IPGW2.Close();
      ...
      public static CANResult Status(HardwareType HWType)
      {
         try
         {
            switch (HWType)
            {
               ...
               case HardwareType.IPGW_1CH:
                  return (CANResult)IpGateway.IPGW1.Status();

               case HardwareType.IPGW_2CH:
                  return (CANResult)IpGateway.IPGW2.Status();
      ...
      public static CANResult Write(HardwareType HWType, TCLightMsg MsgToSend)
      {
         ...
         IpGateway.TPCANMsg MsgIpGw;
         IpGateway.TPCANMsg MsgIpGw2;
         ...
         try
         {
            switch (HWType)
            {
               ...
               case HardwareType.IPGW_1CH:
                  MsgIpGw = MsgToSend;
                  return (CANResult)IpGateway.IPGW1.Write(ref MsgIpGw);

               case HardwareType.IPGW_2CH:
                  MsgIpGw2 = MsgToSend;
                  return (CANResult)IpGateway.IPGW2.Write(ref MsgIpGw2);
      ...
      public static CANResult Read(HardwareType HWType, out TCLightMsg Msg)
      {
         ...
         try
         {
            switch (HWType)
            {
               ...
               case HardwareType.IPGW_1CH:
                  resTemp = (CANResult)IpGateway.IPGW1.Read(out MsgIpGw);
                  Msg = new TCLightMsg(MsgIpGw);
                  return resTemp;

               case HardwareType.IPGW_2CH:
                  resTemp = (CANResult)IpGateway.IPGW2.Read(out MsgIpGw2);
                  Msg = new TCLightMsg(MsgIpGw2);
                  return resTemp;
      ...
      public static CANResult ReadEx(HardwareType HWType, out TCLightMsg Msg, out TCLightTimestamp RcvTime)
      {
         ...
         IpGateway.TPCANTimestamp RcvTimeIpGw;
         IpGateway.TPCANTimestamp RcvTimeIpGw2;
         ...
         try
         {
            switch (HWType)
            {
               ...
               case HardwareType.IPGW_1CH:
                  resTemp = (CANResult)IpGateway.IPGW1.ReadEx(out MsgIpGw, out RcvTimeIpGw);
                  Msg = new TCLightMsg(MsgIpGw);
                  RcvTime = new TCLightTimestamp(RcvTimeIpGw);
                  return resTemp;

               case HardwareType.IPGW_2CH:
                  resTemp = (CANResult)IpGateway.IPGW2.ReadEx(out MsgIpGw2, out RcvTimeIpGw2);
                  Msg = new TCLightMsg(MsgIpGw2);
                  RcvTime = new TCLightTimestamp(RcvTimeIpGw2);
                  return resTemp;
      ...
      public static CANResult VersionInfo(HardwareType HWType, out string strInfo)
      {
         ...
         try
         {
            ...
            switch (HWType)
            {
               ...
               case HardwareType.IPGW_1CH:
                  resTemp = (CANResult)IpGateway.IPGW1.VersionInfo(stbTemp);
                  break;

               case HardwareType.IPGW_2CH:
                  resTemp = (CANResult)IpGateway.IPGW2.VersionInfo(stbTemp);
                  break;
      ...
      public static CANResult DllVersionInfo(HardwareType HWType, out string strInfo)
      {
         ...
         try
         {
            ...
            switch (HWType)
            {
               ...
               case HardwareType.IPGW_1CH:
                  resTemp = (CANResult)IpGateway.IPGW1.DLLVersionInfo(stbTemp);
                  break;

               case HardwareType.IPGW_2CH:
                  resTemp = (CANResult)IpGateway.IPGW2.DLLVersionInfo(stbTemp);
                  break;
      ...
      public static CANResult ResetClient(HardwareType HWType)
      {
         try
         {
            switch (HWType)
            {
               ...
               case HardwareType.IPGW_1CH:
                  return (CANResult)IpGateway.IPGW1.ResetClient();

               case HardwareType.IPGW_2CH:
                  return (CANResult)IpGateway.IPGW2.ResetClient();
      ...
      public static CANResult MsgFilter(HardwareType HWType, uint From, uint To, MsgTypes MsgType)
      {
         try
         {
            switch (HWType)
            {
               ...
               case HardwareType.IPGW_1CH:
                  return (CANResult)IpGateway.IPGW1.MsgFilter(From, To, (int)MsgType);

               case HardwareType.IPGW_2CH:
                  return (CANResult)IpGateway.IPGW2.MsgFilter(From, To, (int)MsgType);
      ...
      public static CANResult ResetFilter(HardwareType HWType)
      {
         try
         {
            switch (HWType)
            {
               ...
               case HardwareType.IPGW_1CH:
                  return (CANResult)IpGateway.IPGW1.ResetFilter();

               case HardwareType.IPGW_2CH:
                  return (CANResult)IpGateway.IPGW2.ResetFilter();
      ...
      public static CANResult SetRcvEvent(HardwareType HWType, System.Threading.EventWaitHandle EventHandle)
      {
         ...
         try
         {
            ...
            switch (HWType)
            {
               ...
               case HardwareType.IPGW_1CH:
                  return (CANResult)IpGateway.IPGW1.SetRcvEvent(EventHandle);

               case HardwareType.IPGW_2CH:
                  return (CANResult)IpGateway.IPGW2.SetRcvEvent(EventHandle);
      ...
      private static void ReceiveProcess(BusContext busContext)
      {
         for (;busContext.receiveThreadExecute; )
         {
            ...
            do
            {
               ...
               rxOk = ((CANResult.ERR_OK == receiveResult) || (CANResult.ERR_QRCVEMPTY == receiveResult));
               moreMsgs = !Convert.ToBoolean(receiveResult & CANResult.ERR_QRCVEMPTY);

               if ((false != rxOk) && (msg.Len > 0) && (null != busContext.receiverHandler))
               {
      ...
      private static HardwareType GetHardwareType(BusInterfaces busInterface)
      {
         ...
         else if (BusInterfaces.IPGWA == busInterface)
         {
            result = HardwareType.IPGW_1CH;
         }
         else if (BusInterfaces.IPGWB == busInterface)
         {
            result = HardwareType.IPGW_2CH;
         }
      ...
      public static CANResult Start(BusInterfaces busInterface, int bitRate, FramesType messageType, TraceGroup traceGroup, ReceiveDelegateHandler receiveHandler, int ioPort = -1, short interrupt = -1)
      {
         ...
         if (false == context[busIndex].active)
         {
            ...
            if ((HardwareType.IPGW_1CH == hardwareType) ||
                (HardwareType.IPGW_2CH == hardwareType))
            {
               result = CANResult.ERR_ILLNET; // use other start method
            }
      ...
      public static CANResult Start(BusInterfaces busInterface, int bitRate, bool useNodeId, int nodeId, FramesType messageType, TraceGroup traceGroup, ReceiveDelegateHandler receiveHandler)
      {
         int busIndex = (int)busInterface;
         ...
         if (false == context[busIndex].active)
         {
            result = CANResult.ERR_OK;
            string dllVersionString = "";
            uint hardwareNodeId = 0;

            if ((HardwareType.USB_1CH != hardwareType) &&
                (HardwareType.USB_2CH != hardwareType))
            {
               result = CANResult.ERR_ILLNET; // use other start method
            }
            ...
            if (false != useNodeId)
            {
               CANResult usb1Result = CANResult.ERR_OK;
               uint usb1NodeId = 0;
               usb1Result = PCANLight.GetUSBDeviceNr(HardwareType.USB_1CH, out usb1NodeId);

               CANResult usb2Result = CANResult.ERR_OK;
               uint usb2NodeId = 0;
               usb2Result = PCANLight.GetUSBDeviceNr(HardwareType.USB_2CH, out usb2NodeId);

               if ((CANResult.ERR_OK == result) && (usb1NodeId == nodeId))
               {
                  hardwareType = HardwareType.USB_1CH;
               }
               else if ((CANResult.ERR_OK == result) && (usb2NodeId == nodeId))
               {
                  hardwareType = HardwareType.USB_2CH;
               }
               else
               {
                  result = CANResult.ERR_BUSOFF;
               }
            }
            ...
            if (CANResult.ERR_OK == result)
            {
               CANResult initResult = PCANLight.Init(hardwareType, interfaceBaudRate, messageType);
            ...
            {
               CANResult deviceNumberResult = CANResult.ERR_OK;
               deviceNumberResult = PCANLight.GetUSBDeviceNr(hardwareType, out hardwareNodeId);
            ...
            if (CANResult.ERR_OK == result)
            {
               context[busIndex].activeHardware = hardwareType;
               context[busIndex].active = true;
               Tracer.WriteHigh(traceGroup, "", "started, version {0}, node id {1}", dllVersionString, hardwareNodeId);
            }
         }
      ...
      public static CANResult Start(BusInterfaces busInterface, FramesType messageType, TraceGroup traceGroup, ReceiveDelegateHandler receiveHandler, IPEndPoint transmitEndPoint, IPEndPoint receiveEndPoint)
      {
         int busIndex = (int)busInterface;
         ...
         if (false == context[busIndex].active)
         {
            ...
            if (CANResult.ERR_OK == result)
            {
               CANResult initResult = PCANLight.Init(hardwareType, messageType, transmitEndPoint, receiveEndPoint);

               if (CANResult.ERR_OK != initResult)
               {
                  Tracer.WriteError(traceGroup, "", "init error {0}", initResult.ToString());
                  result = initResult;
               }
            }
            ...
            if (CANResult.ERR_OK == result)
            {
               ...
               if (CANResult.ERR_OK != resetResult)
               {
                  Tracer.WriteError(traceGroup, "", "reset error {0}", resetResult.ToString());
                  result = resetResult;
               }
            }
            ...
            if (CANResult.ERR_OK == result)
            {
               ...
               if (CANResult.ERR_OK != setEventResult)
               {
                  Tracer.WriteError(traceGroup, "", "receive event error {0}", setEventResult.ToString());
                  result = setEventResult;
               }
            }
            ...
            if (CANResult.ERR_OK == result)
            {
               context[busIndex].activeHardware = hardwareType;
               context[busIndex].active = true;
               Tracer.WriteHigh(traceGroup, "", "started, version {0}", dllVersionString);
            }
         }
      ...
      public static CANResult Start(BusParameters busParameters)
      {
         HardwareType hardwareType = GetHardwareType(busParameters.BusInterface);
         CANResult result = CANResult.ERR_NETINUSE;

         if ((HardwareType.PCI_1CH == hardwareType) ||
             (HardwareType.PCI_2CH == hardwareType))
         {
            PciBusParameters parameters = (PciBusParameters)busParameters;

            ReceiveDelegateHandler receiveHandler = new ReceiveDelegateHandler(parameters.ReceiveHandler);
            result = Start(parameters.BusInterface, parameters.BitRate, parameters.MessageType, parameters.Trace, receiveHandler);
         }
         else if ((HardwareType.USB_1CH == hardwareType) ||
                  (HardwareType.USB_2CH == hardwareType))
         {
            UsbBusParameters parameters = (UsbBusParameters)busParameters;

            ReceiveDelegateHandler receiveHandler = new ReceiveDelegateHandler(parameters.ReceiveHandler);
            result = Start(parameters.BusInterface, parameters.BitRate, parameters.UseNodeId, parameters.NodeId, parameters.MessageType, parameters.Trace, receiveHandler);
         }
         else if ((HardwareType.IPGW_1CH == hardwareType) ||
                  (HardwareType.IPGW_2CH == hardwareType))
         {
            IpGatewayBusParameters parameters = (IpGatewayBusParameters)busParameters;

            ReceiveDelegateHandler receiveHandler = new ReceiveDelegateHandler(parameters.ReceiveHandler);
            result = Start(parameters.BusInterface, parameters.MessageType, parameters.Trace, receiveHandler, parameters.TransmitEndPoint, parameters.ReceiveEndPoint);
         }
      ...
      public static CANResult ResetBus(BusInterfaces busInterface)
      {
         ...
         if (false != context[busIndex].active)
         {
            ...
            if (CANResult.ERR_OK == result)
            {
               Tracer.WriteHigh(context[busIndex].traceGroup, "", "bus reset");
            }
            else
            {
      ...
      public static CANResult SendSync(BusInterfaces busInterface)
      {
         ...
         if (false != context[busIndex].active)
         {
            ...
            msg.Data[0] = (byte)0x00;
            msg.Data[1] = (byte)0x00;
            msg.Data[2] = (byte)0x00;
            msg.Data[3] = (byte)0x00;
            msg.Data[4] = (byte)0x00;
            msg.Data[5] = (byte)0x00;
            msg.Data[6] = (byte)0x00;
            msg.Data[7] = (byte)0x00;
            ...
            {
               Tracer.WriteHigh(context[busIndex].traceGroup, "", "sync");
            }
         }
      ...
      public static CANResult SendTimestamp(BusInterfaces busInterface, UInt32 timeStamp)
      {
         ...
         if (false != context[busIndex].active)
         {
            ...
            {
               Tracer.WriteHigh(context[busIndex].traceGroup, "", "timestamp");
            }
         }
