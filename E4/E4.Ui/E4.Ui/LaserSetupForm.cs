...
namespace E4.Ui
{
   ...
   public partial class LaserSetupForm : Form
   {
      ...
      private void LaserSampleTimeValueButton_Click(object sender, EventArgs e)
      {
         ValueButton valueButton = (ValueButton)sender;
         this.LaunchNumberEdit(valueButton, ParameterAccessor.Instance.LaserSampleTime);
         this.LaserSampleTimeValueButton.ValueText = this.GetValueText(ParameterAccessor.Instance.LaserSampleTime);
      }

      private void LaserSampeCountValueButton_Click(object sender, EventArgs e)
      {
         ValueButton valueButton = (ValueButton)sender;
         this.LaunchNumberEdit(valueButton, ParameterAccessor.Instance.LaserSampleCount);
