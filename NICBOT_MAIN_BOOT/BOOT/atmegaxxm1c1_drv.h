...
#ifndef _ATMEGAXXM1C1_DRV_H_
#define _ATMEGAXXM1C1_DRV_H_

//_____ I N C L U D E S ____________________________________________________
//#include <intrinsics.h> mh
...
//#define Disable_interrupt()     { __disable_interrupt(); }    //- Intrinsic function mh
...
//! @return none
//-----
#define Hard_reset()    { WDTCSR |= 1<<WDE;  while(1); }
...
//! @return none
//-----
#define WD_off()    { MCUSR &= ~(1<<WDRF); WDTCSR = (1<<WDCE) | (1<<WDE); WDTCSR = 0; }
